package com.parchlinux.transfer;
...
import com.parchlinux.transfer.R;
...
public class MainActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemID == R.id.settings) {
            ...
            ((ImageView)v.findViewById(R.id.imgQR)).setImageBitmap(Utils.getQRCodeBitmap("Parch Transfer://"+host));
            dialog.show();
            ...
            intent.putExtra(Intent.EXTRA_TITLE, "Parch Transfer-log.txt");
    ...
    public static boolean trySetDefaultDirectory(Activity a) {
        ...
        File dir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "Parch Transfer");
