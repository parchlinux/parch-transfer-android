...
public class MainService extends Service {
    ...
    static void scheduleAutoStop() {
        if (svc != null && svc.runningTransfers == 0 && svc.autoStopTask == null &&
                svc.isAutoStopEnabled() && ParchTransferApp.activitiesRunning < 1) {
    ...
    private Notification createForegroundNotification() {
        ...
        String notificationTitle = getString(R.string.parchtransfer_notification_title);
        String notificationButton = getString(R.string.parchtransfer_notification_button);
