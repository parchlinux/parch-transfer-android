...
public class TransfersActivity extends AppCompatActivity {
    ...
    private void openFiles() {
        ...
        ParchTransferApp.activitiesRunning++; //Prevent autostop
    ...
    private void openFolder() {
        ...
        try {
            ...
            ParchTransferApp.activitiesRunning++; //Prevent auto-stop only if actually opened
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SEND_FILE_REQ_CODE || requestCode == SEND_FOLDER_REQ_CODE) {
            ...
            ParchTransferApp.activitiesRunning--;
